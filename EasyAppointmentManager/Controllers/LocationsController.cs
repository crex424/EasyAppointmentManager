...
namespace EasyAppointmentManager.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LocationID,Address,City,ZipCode,LocationName")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationID,Address,City,ZipCode,LocationName")] Location location)
        {
